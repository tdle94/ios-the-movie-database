...
class PopularMovieViewModel: MovieViewModel {
    override func fetch() async throws {
        ...
        homeViewObjects = movieResults.compactMap { HomeViewObject(title: $0.originalTitle, posterLink: $0.posterLink) }
    }
}
...
class LatestMovieViewModel: MovieViewModel {
    override func fetch() async throws {
        ...
        homeViewObjects = [HomeViewObject(title: latestMovie.originalTitle, posterLink: "https://image.tmdb.org/t/p/original/" + (posterPath ?? ""))]
    }
}
